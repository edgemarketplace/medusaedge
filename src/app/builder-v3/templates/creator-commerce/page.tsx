...
export default function TemplatePage() {
  const theme = getDesignTokens('streetwear-dark')
  ...
  return (
    <main className="min-h-screen" style={{ backgroundColor: theme?.colors?.background || '#ffffff' }}>
      <div className="flex items-center justify-between border-b border-gray-200 px-4 py-3">
        ...
        <span className="text-sm font-bold">Template: Creator Commerce</span>
        <span className="text-sm text-gray-500">Streetwear Dark</span>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl mb-8 max-w-2xl" style={{ fontFamily: theme?.fonts?.grotesk || 'sans-serif' }}>
          Discover products curated by top influencers and creators.
        </p>
        <button 
          onClick={() => window.location.href = '/builder-v3/editor?template=creator-commerce'}
