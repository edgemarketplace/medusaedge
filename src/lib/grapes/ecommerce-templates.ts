...
<section class="bg-white px-6 py-12" data-template-source="landscaping-growth-pro"><div class="mx-auto grid max-w-7xl gap-4 md:grid-cols-3">${["Weekly mow plan","Premium yard detail","Irrigation tune-up"].map(t=>`<div class="rounded-2xl border border-green-100 p-5"><p class="font-black text-green-900" data-gjs-editable="true">${t}</p></div>`).join("")}</div></section>${footer("landscaping-growth-pro", "bg-green-950 text-white")}`,
  },
  {
...
<section class="bg-white px-6 py-12" data-template-source="cleaning-booking-studio"><div class="mx-auto max-w-7xl grid gap-4 md:grid-cols-4">${["Studio","1 Bedroom","2 Bedroom","Move-out"].map(t=>`<div class="rounded-2xl border border-cyan-100 p-4"><p class="font-black text-cyan-900" data-gjs-editable="true">${t}</p><p class="text-xs text-slate-500" data-gjs-editable="true">Edit duration + price</p></div>`).join("")}</div></section>${footer("cleaning-booking-studio", "bg-cyan-950 text-white")}`,
  },
  {
...
<section class="bg-white px-6 py-12" data-template-source="pet-grooming-care-club"><div class="mx-auto grid max-w-7xl gap-4 md:grid-cols-3">${["Bath + Brush","Full Groom","Monthly Care Club"].map(t=>`<div class="rounded-2xl border border-amber-100 p-5"><p class="font-black text-amber-900" data-gjs-editable="true">${t}</p></div>`).join("")}</div></section>${footer("pet-grooming-care-club", "bg-amber-950 text-white")}`,
  },
  {
...
<section class="bg-white px-6 py-12" data-template-source="florist-atelier-orders"><div class="mx-auto grid max-w-7xl gap-4 md:grid-cols-4">${["Birthday","Anniversary","Sympathy","Wedding"].map(t=>`<div class="rounded-2xl border border-rose-100 p-4"><p class="font-black text-rose-900" data-gjs-editable="true">${t}</p></div>`).join("")}</div></section>${footer("florist-atelier-orders", "bg-rose-950 text-white")}`,
  },
]
